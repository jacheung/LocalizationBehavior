function [all_theta] = ML_oneVsAllTMP(X, y, num_labels, lambda)
...
[theta, J, exit_flag] = ...
    fminunc(@(t)(ML_lrCostFunction(t, X, (y == c), lambda)), initial_theta, options);

% [theta] = ...
%          fmincg (@(t)(ML_lrCostFunction(t, X, (y == c), lambda)), ...
%                  initial_theta, options);
